...
impl ImportState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ImportState::ImportDownloaded => "ImportDownloaded",
            ImportState::ImportParsed => "ImportParsed",
            ImportState::ImportPersisted => "ImportPersisted",
            ImportState::ImportCompleted => "ImportCompleted",
            ImportState::ImportAllocSegment => "ImportAllocSegment",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ImportDownloaded" => Some(Self::ImportDownloaded),
            "ImportParsed" => Some(Self::ImportParsed),
            "ImportPersisted" => Some(Self::ImportPersisted),
            "ImportCompleted" => Some(Self::ImportCompleted),
            "ImportAllocSegment" => Some(Self::ImportAllocSegment),
            _ => None,
        }
    }
}
...
impl ObjectPrivilege {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "PrivilegeDescribePartition" => Some(Self::PrivilegeDescribePartition),
            _ => None,
        }
    }
}
